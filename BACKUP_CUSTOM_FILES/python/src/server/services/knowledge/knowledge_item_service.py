...
class KnowledgeItemService:
    ...
    async def list_items(
        ...
        try:
            ...
            count_query = self.supabase.from_("sources").select(
            ...
            if source_ids:
                ...
                urls_result = (
                    self.supabase.from_("crawled_pages")
                ...
                for source_id in source_ids:
                    count_result = (
                        self.supabase.from_("code_examples")
    ...
    async def get_available_sources(self) -> Dict[str, Any]:
        ...
        try:
            ...
            result = (
                self.supabase.from_("sources").select("*").order("source_id").execute()
            )
